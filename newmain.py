...
displayw, displayh = screendims # Display dimensions
...
def drawMenuBar(display: pygame.Surface, page: int) -> None:
    ...
    pygame.draw.rect(display, bin.cfgs.colors["menubackground"], pygame.Rect(coords[0], coords[1], displayw - coords[0], displayh - coords[1]))
